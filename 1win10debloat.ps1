...
$appsperso                     = New-Object system.Windows.Forms.Button
$appsperso.text                = "Apps Perso(steam origin uplay teamspeak discord)"
$appsperso.width               = 150
$appsperso.height              = 30
$appsperso.location            = New-Object System.Drawing.Point(417,61)
$appsperso.Font                = New-Object System.Drawing.Font('Microsoft Sans Serif',12)
...
$Panel1.controls.AddRange(@($installchoco,$brave,$firefox,$7zip,$irfanview,$appsperso,$notepad,$gchrome,$mpc,$vlc,$powertoys,$winterminal,$vscode,$Label2))
...
$appsperso.Add_Click({ 
    Write-Host "Installing steam origin uplay teamspeak discord"
    choco install steam origin uplay teamspeak discord -y
	$wshell.Popup("Operation Completed",0,"Done",0x0)
})
