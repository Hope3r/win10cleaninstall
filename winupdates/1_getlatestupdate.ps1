...
Param(
    ...
    [ValidateSet('16299','15063','14393','10586','10240','2004')]
    [string] $BUild = '2004',
...
$kbObj1 = Invoke-WebRequest -Uri "http://www.catalog.update.microsoft.com/Search.aspx?q=KB4592438"
$kbObj2 = Invoke-WebRequest -Uri "http://www.catalog.update.microsoft.com/Search.aspx?q=KB4593175"


$Available_KBIDs = $kbObj1.InputFields | 
Where-Object { $_.type -eq 'Button' -and $_.Value -eq 'Download' } | 
Select-Object -ExpandProperty  ID

$Available_KBIDs | out-string | write-verbose

$kbGUIDs = $kbObj1.Links | 
